...
namespace TensionDev.Maritime.AIS
{
    ...
    /// </summary>
    public class AISMessage09 : AISMessage
    {
        ...
        protected UInt16 altitudeSensor1;
        protected UInt16 spare7;
        ...
        /// </summary>
        public Boolean AltitudeAvailable { get => Altitude < 4095; }

        /// <summary>
        /// Speed Over Ground in Knots
        /// </summary>
        public Decimal SpeedOverGroundKnots { get => speedOverGround10; set => speedOverGround10 = (UInt16)Math.Min(1023, Math.Abs(value)); }
        ...
        /// </summary>
        public AltitudeSensorEnum AltitudeSensor { get => (AltitudeSensorEnum)(altitudeSensor1); set => altitudeSensor1 = (UInt16)value; }
        ...
        private void GetBitVector120_167()
        {
            ...
            _bitVector120_167 <<= 1;
            _bitVector120_167 |= altitudeSensor1;

            _bitVector120_167 <<= 7;
            _bitVector120_167 |= spare7;

            _bitVector120_167 <<= 1;
            _bitVector120_167 |= dataTerminalEquipment1;

            _bitVector120_167 <<= 3;
            _bitVector120_167 |= spare3;

            _bitVector120_167 <<= 1;
            _bitVector120_167 |= assignedModeFlag1;
        ...
        private void SetBitVector0_59()
        {
            ...
            altitude12 = (UInt16)(_bitVector0_59 & 0xFFF);
            _bitVector0_59 >>= 12;
        ...
        private void SetBitVector120_167()
        {
            ...
            assignedModeFlag1 = (UInt16)(_bitVector120_167 & 0x1);
            _bitVector120_167 >>= 1;

            spare3 = (UInt16)(_bitVector120_167 & 0x7);
            _bitVector120_167 >>= 3;

            dataTerminalEquipment1 = (UInt16)(_bitVector120_167 & 0x1);
            _bitVector120_167 >>= 1;

            spare7 = (UInt16)(_bitVector120_167 & 0x7F);
            _bitVector120_167 >>= 7;

            altitudeSensor1 = (UInt16)(_bitVector120_167 & 0x1);
            _bitVector120_167 >>= 1;
        ...
        public enum AltitudeSensorEnum
        {
            /// <summary>
            /// 0 = GNSS
            /// </summary>
